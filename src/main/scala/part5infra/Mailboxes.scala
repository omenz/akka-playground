...
object Mailboxes extends App {
  ...
  class SupportTicketPriorityMailbox(settings: ActorSystem.Settings, config: Config)  // used in config
...
//  supportTicketLogger ! "[P1] do this when you have the time"
  ...
  /**
    ...
    */
  // step 1 - mark important messages as control messages, these messages are processed before all the messages
