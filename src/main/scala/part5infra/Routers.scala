...
//  }
  ...
  val poolMaster2 = system.actorOf(FromConfig.props(Props[Slave]), "poolMaster2")// will look in to application.conf by actor name
//  for (i <- 1 to 10) {
...
//  }
  ...
  /**
    * Special messages
    */
  groupMaster2 ! Broadcast("hello, everyone") // will be sent to every single routed actor
